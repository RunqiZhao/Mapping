...
### These are the 2 target maps that are created with the "hurricaneexposure" package. 
```{r echo=FALSE, warning = FALSE, message = FALSE}
...
# Could also try: rain_99$rainfall <- cut(rain_99$rainfall, breaks = c(0, 25, 50, 75,
# 100, 125, 150, 175, 200, 225), include.lowest = TRUE)) 
...
p21 <- plot_usmap(data = rain_01, values = "rainfall", color = "grey", include = rain_01$fips) +
  ...
  # Use the scale_fill_manual function could make this map more similar to the target
  # map and also makes the two colors more distinguishable. 
  scale_fill_manual(values = c("white", "darkblue"), name = "Rainfall > 175mm") + 
...
# We changed the color of the leaflet maps from "RdPu" to "Blues" to make them 
# more identical to the target maps. Just to clarify, the original maps your team 
# made are perfect, we just would like to try out another color! 
